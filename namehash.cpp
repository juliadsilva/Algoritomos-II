...
// Funcao para gerar a chave 
int gera_chave(char nome[], int comp){

    int i; //contador
    int n[100]; // Variavel para armazenar o numero correspondente a letra
    int chave; //soma e retorno da funcao
...
int main()
{
    ...
    char nome[100]; //nome que gera a chave
    int comp; //comprimento do nome
    int i; // contador
    int k; // chave 
