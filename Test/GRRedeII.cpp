...
void cria_arestra(list<no>lista[], int u, int v, double p, int orientado)
{
...
int main()
{
    ...
    double p; //peso da aresta, se o grafo for ponderado
    int orientado; //um se for orientado, zero caso contrario    
    int nVertices; //numero de vertices do grafos
    int i; //contador
    ...
    //Lendo o numero de computador - vertices do grafo
    cin >> nVertices;

    //Lendo computador inicial - vértice inicial da árvore
    cin >> s;
